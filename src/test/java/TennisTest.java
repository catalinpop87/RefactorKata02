...
public class TennisTest {
    ...
    public final String expectedScore;
    ...
    public void checkAllScores(TennisGamePlay game) {
    ...
    public void checkAllScoresTennisGame() {
        TennisGamePlay game = new TennisGamePlay(new Player("player1"),new Player("player2") );
        checkAllScores(game);
    }
}